...
# ------------------------------------------------------------
# Главная страница с полным интерфейсом и адаптивными стилями
# ------------------------------------------------------------
@app.get("/")
def index():
...
<head>
    ...
    <style>
        * { transition: all 0.2s ease; }
        ...
        /* ---------- БАЗА ЗНАНИЙ (адаптивные карточки) ---------- */
        ...
        /* ---------- ДАШБОРД (адаптивные контейнеры графиков) ---------- */
...
<div class="max-w-7xl mx-auto px-4 py-6 container">
    <div class="flex justify-between items-center mb-8 p-4 bg-white dark:bg-gray-800 shadow rounded-2xl border">
        ...
        <div class="flex gap-4 items-center">
            ...
            <a href="/privacy" target="_blank" class="text-xs text-gray-500 dark:text-gray-400 hover:underline transition">Политика конфиденциальности</a>
